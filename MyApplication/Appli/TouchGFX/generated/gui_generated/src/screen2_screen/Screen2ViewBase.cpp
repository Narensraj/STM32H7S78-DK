    ...
    gaugeValueSetCallback(this, &Screen2ViewBase::gaugeValueSetCallbackHandler)
{
    ...
    readoutText.setColor(touchgfx::Color::getColorFromRGB(33, 36, 50));
    readoutText.setLinespacing(0);
    Unicode::snprintf(readoutTextBuffer, READOUTTEXT_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_I0RE).getText());
    readoutText.setWildcard(readoutTextBuffer);
    readoutText.setTypedText(touchgfx::TypedText(T___SINGLEUSE_AJ1L));
    add(readoutText);
}
